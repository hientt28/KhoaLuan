        ...
        <div class="col-md-7 col-md-offset-2">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::model($app, ['route' => ['appliances.update', $app['id']], 'class' => 'form-horizontal', 'enctype' =>"multipart/form-data", 'method' => 'PUT']) !!}
                        ...
                        <div class="form-group">
                            <div class="col-md-5 col-md-offset-6">
                                ...
                                <a href="{{ route('appliances.index') }}" class="btn btn-success"><i class="fa fa-chevron-circle-left"></i>{{ trans('common.back') }}</a>
                            </div>
                        </div>
                    {!! Form::close() !!}
                </div>
